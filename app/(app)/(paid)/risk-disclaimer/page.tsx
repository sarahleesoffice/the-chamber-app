  ...
  return (
    <div className="space-y-6">
      ...
      <Section title="About The Chamber">
        ...
        <P>
          The SMC (Smart Money Concepts) methodology referenced throughout this application is based
          on publicly available educational content by Michael J. Huddleston. The Chamber is not
          affiliated with, endorsed by, or officially connected to SMC/Michael J. Huddleston in
          any way. All SMC concepts are used strictly for educational reference.
        </P>
        <P>
      ...
      <div className="bg-chamber-surface border border-chamber-border rounded-lg p-6">
        ...
        <P>
          ...
          Google) and pay them directly. Every time you ask a question — in SMC Chat, AI Analysis,
        ...
        <div className="mt-5 pt-4 border-t border-chamber-border">
          ...
          <ul className="text-chamber-text-muted text-[0.82rem] leading-loose pl-5 list-disc space-y-0.5">
            ...
            <li><span className="text-chamber-orange font-semibold">Bias Analysis</span> costs a little more than a chat question because it sends candle data + SMC transcripts to the AI</li>
