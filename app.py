...
if not is_logged_in():
    ...
    <style>
        ...
        section[data-testid="stSidebar"] > div:first-child::before { content:""; display:block; width:40px; height:40px; margin:10px auto 4px; background-image:url("data:image/svg+xml,%3Csvg viewBox='0 0 100 100' xmlns='http://www.w3.org/2000/svg'%3E%3Ccircle cx='50' cy='50' r='46' fill='none' stroke='%23e8651a' stroke-width='2.5' opacity='0.6'/%3E%3Ccircle cx='50' cy='50' r='36' fill='none' stroke='%23e8651a' stroke-width='1.5' opacity='0.3'/%3E%3Cpath d='M50 18 C40 35,30 42,30 55 C30 66,39 75,50 75 C61 75,70 66,70 55 C70 42,60 35,50 18Z' fill='none' stroke='%23e8651a' stroke-width='2.5'/%3E%3Cpath d='M50 32 C44 42,38 47,38 55 C38 62,43 67,50 67 C57 67,62 62,62 55 C62 47,56 42,50 32Z' fill='%23e8651a' opacity='0.2'/%3E%3Ccircle cx='50' cy='54' r='5' fill='%23e8651a' opacity='0.7'/%3E%3C/svg%3E"); background-size:contain; background-repeat:no-repeat; }
        section[data-testid="stSidebar"] > div:first-child::after { content:"THE CHAMBER"; display:block; text-align:center; font-size:1.1rem; font-weight:700; color:#e8651a; letter-spacing:3px; text-shadow:0 0 20px rgba(232,101,26,0.3); padding:0 16px 8px; border-bottom:1px solid #1e1a17; margin-bottom:2px; }
...
<style>
    ...
    /* Remove extra padding above nav */
    section[data-testid="stSidebar"] [data-testid="stSidebarNav"] {
        padding-top: 0 !important;
        margin-top: 0 !important;
    }
