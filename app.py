...
if not is_logged_in():
    ...
    <style>
        ...
        /* Sidebar nav hover — orange glow on login page too */
        section[data-testid="stSidebar"] [data-testid="stSidebarNavLink"]:hover,
        section[data-testid="stSidebar"] [data-testid="stSidebarNavLink"]:hover a,
        section[data-testid="stSidebar"] [data-testid="stSidebarNav"] a:hover {
            background: rgba(232,101,26,0.10) !important;
            text-shadow: 0 0 8px rgba(232,101,26,0.5), 0 0 20px rgba(232,101,26,0.25) !important;
        }
        ...
        section[data-testid="stSidebar"] [data-testid="stSidebarNav"] a:hover svg {
            fill: #ff7e33 !important; color: #ff7e33 !important;
        }
    </style>
...
<style>
    ...
    /* Kill any gap between logo and first nav group */
    ...
    /* Base transition on all nav links */
